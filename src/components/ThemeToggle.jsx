...
function SunIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={iconClass} aria-hidden>
...
export function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="flex items-center justify-center rounded-lg p-2 text-primary hover:text-accent hover:bg-elevated/80 transition-colors cursor-pointer"
        >

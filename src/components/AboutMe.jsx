        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-18 w-9/10 md:w-4/5 mx-auto bg-gradient-to-br from-black via-zinc-900 to-neutral-800 p-4 md:p-12 rounded-[2rem]">
                ...
                <div className="md:col-span-2">
                    ...
                    <p className="nunito-sans-regular text-sm md:text-lg my-4 leading-relaxed text-gray-300">Programming entered my life later, almost by accident. I had assumed it wouldn't suit me, until I discovered how naturally it aligned with what I already loved: learning, problem-solving, and assembling ideas elegantly.</p>
